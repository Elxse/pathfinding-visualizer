...
I came across this [Pathfinding visualizer project](https://github.com/clementmihailescu/Pathfinding-Visualizer) of Clément Mihailescu using CSS and Javascript, and I thought that it was a great idea to visualize the algorithms in action. I implemented some of them in Python, and used [pygame](https://www.pygame.org/docs/) and [pygame-gui](https://pygame-gui.readthedocs.io/en/latest/index.html) to build the user interface. 
